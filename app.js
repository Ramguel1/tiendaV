var productos=["coca","galleta","jugo"];
var precios=[19,20,15];
...
const imprimirTabla=()=>{
    ...
    carrito.forEach(item=>{
        ...
        <td><button class="btn btn-danger" onclick="eliminarProducto(${index[0]})"><i class="bi bi-file-earmark-excel"></i></button></td>
        </tr>
        `
        index++;
...
const limpiarTabla=()=>{
 ...
 const verProductos=()=>{
   ...
   productos.forEach(item=>{
       ...
       <td><button class="btn btn-danger m-2 w-50" value="Borrar" onclick="bProducto(${index})">quitar</button></td>
